...
\begin{minipage}[c][9cm][c]{0.1\textwidth}
  \begin{center}
    \includegraphics[width=10cm,angle=0]{figs/kepler.eps}
  \end{center}
\end{minipage}
...
\end{align}
in which $\Lambda$ is an appropriate subspace.

In our experiments, it turns out to be useful to impose uniform priors for the model parameters.
...
Using the PyKE package in Python, the PSF photometry can be coded as:
